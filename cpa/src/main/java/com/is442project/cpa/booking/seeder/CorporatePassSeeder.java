...
//        Membership membership4 =  membershipRepository.findById(Long.valueOf(4)).get();
        ...
        CorporatePass pass3 = new CorporatePass(membership1, "CARD0003", Status.LOST, 4);
...
//        CorporatePass pass8 = new CorporatePass(membership3, "CARD0008", Status.LOANED, 2);
        CorporatePass pass20 = new CorporatePass(membership2, "22401046113600009088", Status.AVAILABLE, 2);
        CorporatePass pass21 = new CorporatePass(membership2, "22401046113600009089", Status.AVAILABLE, 2);
...
//        CorporatePass pass24 = new CorporatePass(membership4, "22401046113600009092", Status.AVAILABLE, 2);
        ...
        List<CorporatePass> corporatePasses = Arrays.asList(pass1, pass2, pass3,pass20, pass21);
