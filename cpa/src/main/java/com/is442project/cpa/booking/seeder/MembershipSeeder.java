...
public class MembershipSeeder {
    ...
    public void insertTestData() {
        ...
        Membership membership1 = new Membership("Mandai Wildlife Reserve", "80 Mandai Lake Rd", physicalEmailTemplate, authorizationLetterAttachmentTemplate,
                53.50, false,
...
//        membership3.setMembershipGrade("CFOZ PREMIUM");
        ...
        membershipRepository.saveAllAndFlush(Arrays.asList(membership1, membership2));

        System.out.println("======TEST MEMBERSHIPS INSERTED======");
