...
public class MembershipSeeder {
    ...
    public String buildSamplePhysicalPassEmailTemplate() {
        ...
        sb.append("<br><br>");
        sb.append(
                "Attached is the authorisation letter to <attraction_name>. Please check that the details are accurate.");
        sb.append("<br><br>");
        ...
        sb.append(
                "<li>Collect the membership card(s) from the General Office one day before your visit date and return the membership card(s) by 9am the next working day after your visit.</li>");
        sb.append(
                "<li>Present the membership card(s), the authorisation letter and your staff pass at the entrance of <attraction_name>.</li>");
        sb.append("<li>Entry is strictly based on the membership card(s) and the authorisation letter.</li>");
        sb.append(
                "<li>Your presence is required on the day of visit. Entry will be denied without staff’s presence.</li>");
        sb.append("<li>Your booking is non-transferable.</li>");
        sb.append(
                "<li>Visit date is strictly based on the date stated in this email and the authorisation letter.</li>");
